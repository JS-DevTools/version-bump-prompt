...
describe('bump --prepatch', () => {
  ...
  it('should treat empty version numbers as 0.0.0', () => {
    ...
    output.lines.should.deep.equal([
      '✔ Updated package.json to 0.0.1-beta.0',
      '✔ Updated bower.json to 0.0.1-beta.0',
      '✔ Updated component.json to 0.0.1-beta.0',
    ]);
  ...
  it('should reset the minor and patch', () => {
    ...
    output.lines.should.deep.equal([
      '✔ Updated package.json to 1.2.4-beta.0',
    ]);
  ...
  it('should honor the --preid flag', () => {
    ...
    let output = cli.exec('--prepatch --preid alpha');

    output.stderr.should.be.empty;
    output.status.should.equal(0);

    output.lines.should.deep.equal([
      '✔ Updated package.json to 1.2.4-alpha.0',
    ]);
